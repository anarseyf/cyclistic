...
```{r data imports}
agg_daily_computed_weekdays <- read.csv("./datasets/agg_daily_computed_weekdays.csv")
...
agg_monthly_type_status <- read.csv("./datasets/agg_monthly_type_status.csv")
weather_correlations <- read.csv("./datasets/weather_correlations.csv")
