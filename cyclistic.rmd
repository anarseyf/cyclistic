...
index <- heatmap_friday$diff > 0
heatmap_friday$log_diff[index] <- log10(heatmap_friday$diff[index])
heatmap_friday$log_diff[heatmap_friday$diff <= 0] <- NA


glimpse(heatmap_friday$diff)
glimpse(heatmap_friday$log_diff)
...
ggmap(map, darken = 0.3) +
  ...
  scale_color_steps(low = "#ffff17", high = "#e90505", na.value = "#0527e6") +
